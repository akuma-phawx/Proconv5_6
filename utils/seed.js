...
const Currency = require("../api/models/currencyModel");
...
const seedDb = async () => {
  ...
  for (let currentCurrency of allCurrencies) {
    const newCurrency = new Currency({
      base: currentCurrency.code,
...
seedDb().then(() => {
  ...
  console.log("Entries added successfully, exiting DB.");
});
